...
[The Refinitiv Data Platform Libraries for .NET (RDP.NET)](https://developers.refinitiv.com/refinitiv-data-platform/refinitiv-data-platform-libraries) is a new community-based library which is designed as ease-of-use interfaces. The below picture depicts the architecture of RDP Libraries.
