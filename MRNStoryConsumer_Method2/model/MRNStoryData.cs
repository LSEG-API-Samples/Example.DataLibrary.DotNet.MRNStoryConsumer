using MRNStoryConsumer_Method2.Enum;
using Newtonsoft.Json;
namespace MRNStoryConsumer_Method2.Model
{
    public class MrnStoryData
    {
        ...
        public Enum.MessageTypeEnum MsgType { get; set; }
        ...
        public Enum.MrnTypeEnum MRN_TYPE { get; set; }
